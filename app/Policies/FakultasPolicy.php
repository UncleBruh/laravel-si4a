...
class FakultasPolicy
{
    ...
    {
        return $user->role === 'admin' or $user->role === 'dosen';// ini kalo nak 2 || $user->role === 'dosen'; // Only allow users with the 'admin' role to create Fakultas
    }
    ...
    {
         return $user->role === 'admin'; // hanya admin yang bisa update fakultas
    }
